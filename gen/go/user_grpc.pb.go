...
const (
	...
	User_CheckToken_FullMethodName = "/User/CheckToken"
)
...
func (c *userClient) CheckToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
...
func (UnimplementedUserServer) CheckToken(context.Context, *TokenRequest) (*TokenResponse, error) {
...
func _User_CheckToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CheckToken(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
